...
func NewRuntime(cfg Config, eventBusCfg config.EventBusConfig, log logger.Logger) (jobs.Runtime, error) {
	return newRuntime(cfg, eventBusCfg, config.KafkaValidationConfig{}, log, eventbusconstruct.NewFromConfigWithValidation)
}
...
func NewRuntimeWithValidation(
	...
	return newRuntime(cfg, eventBusCfg, validationCfg, log, eventbusconstruct.NewFromConfigWithValidation)
}
...
func NewBackend(cfg Config, eventBusCfg config.EventBusConfig, log logger.Logger) (jobs.Backend, error) {
	return newBackend(cfg, eventBusCfg, config.KafkaValidationConfig{}, log, eventbusconstruct.NewFromConfigWithValidation)
}
...
func NewBackendWithValidation(
	...
	return newBackend(cfg, eventBusCfg, validationCfg, log, eventbusconstruct.NewFromConfigWithValidation)
}
