...
// ApplyDefaults registers default jobs configuration values.
...
// BindEnv binds jobs configuration keys to environment variables.
...
// Validate checks that jobs configuration is coherent for the selected backend.
