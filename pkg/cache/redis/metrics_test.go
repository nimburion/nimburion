...
func TestMetrics_RegisterInCustomRegistryOnly(t *testing.T) {
	...
	assertMetricPresent(t, registry.Gatherer(), "nimburion_cache_redis_operations_total")
	assertMetricAbsent(t, prometheus.DefaultGatherer, "nimburion_cache_redis_operations_total")
}
