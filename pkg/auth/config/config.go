...
// ApplyDefaults registers default auth configuration values.
...
// BindEnv binds auth configuration keys to environment variables.
...
// Validate checks that enabled auth configuration is complete and coherent.
